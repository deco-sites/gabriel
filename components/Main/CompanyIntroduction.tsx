...
export default function CompanyIntroduction(props: Props) {
  ...
  return (
    <section class="container mx-auto grid md:grid-cols-2 md:flex-col grid-cols-1 min-h-[646px] relative mt-[15%] mx-[2%] relative md:(mx-auto mt-0) md:top-[46px] lg:top-[68.09px] place-items-center">
        ...
        {linksList.filter((props) => props.link).length > 0 && (
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            {linksList.map((props) => (
              <a
                href={props.link}
                class="bg-[#00CE7C] font-medium text-white rounded-full md:text-[15px] w-max break-words h-auto text-center py-[12px] px-[24px] cursor-pointer font-semibold inline-block leading-[15px]"
      ...
      <div class="sm:mx-auto mx-[2%] flex justify-center">
        <Image
          class="object-cover col-span-1 md:(mb-[32%]) lg:(mb-[15%]) md:max-w-[75.5%] max-w-100% w-[100%]) self-auto"
          src={props.img}
          alt={"background"}
          width={440.02}
          height={500.7}
