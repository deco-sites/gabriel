  ...
  return (
    <section class="container mx-auto flex flex-col">
        <div class="lg:mx-0 md:mx-[2%] flex flex-col justify-center">
            ...
            <div class="flex items-center md:flex-row flex-col text-center md:text-left shadow-custom lg:(pr-[10px] pl-[20px] py-[20px]) p-[10px] rounded-[16px] md:mt-[2%] m-[8%] sm:(my-[8%] mt-[8%] mb-[7%]) md:m-0">
